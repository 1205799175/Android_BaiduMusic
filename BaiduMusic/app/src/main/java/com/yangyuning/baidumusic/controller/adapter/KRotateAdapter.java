 ...
 * K歌 轮播图 适配器
 */
public class KRotateAdapter extends PagerAdapter {
    private List<KRotareBean.ResultBean> datas;
    private Context context;
    private LayoutInflater inflater;

    public KRotateAdapter(Context context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
    }

    public void setDatas(List<KRotareBean.ResultBean> datas) {
        this.datas = datas;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Picasso.with(context).load(datas.get(newPosition).getPicture()).into(imageView);
